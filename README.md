...
- --instance-init-time: Maximum duration (in seconds) after an instance is launched before being considered unhealthy (running in Azure but not joining the Kubernetes cluster)
